...
BEGIN {
    ...
    require '/d/city_chain_project/msys64/home/openssl-3.3.1/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/d/city_chain_project/msys64/home/openssl-3.3.1/test/fips-and-base.cnf';
    shift;
